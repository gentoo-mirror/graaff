...
SRC_URI="https://rubygems.org/gems/tinymce-rails-5.0.10.gem https://download.ephox.com/tinymce/community/tinymce_${PV}.zip https://download.ephox.com/tinymce/community/tinymce_${PV}_dev.zip"
...
all_ruby_prepare() {
	...
	sed -i -e 's/5.0.10/'${PV}'/' ../metadata lib/tinymce/rails/version.rb || die
}
